...
export default function navigationcard({ children }) {
  ...
  const inactiveElements =
    "flex text-sm md:text-md md:gap-3 mx-1 gap-1 px-4 py-2 hover:bg-blue-300 hover:bg-opacity-40 rounded-md transition-all hover:shadow-sm hover:shadow-gray-400 hover:text-base hover:scale-110";
